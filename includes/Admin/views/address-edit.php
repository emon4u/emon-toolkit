<div class="wrap">
    <h1><?php _e( 'Edit Address', 'emon-toolkit' );?></h1>
    <?php if ( isset( $_GET['address-updated'] ) ) {?>
        <div class="notice notice-success">
            <p><?php _e( 'Address has been updated successfully!', 'emon-toolkit' );?></p>
        </div>
    <?php }?>
    ...
    <form action="" method="post">
        <table class="form-table">
            <tbody>
                <tr class="row<?php echo $this->has_error( 'name' ) ? ' form-invalid' : ''; ?>">
                    <th scope="row">
                        <label for="name"><?php _e( 'Name', 'emon-toolkit' );?></label>
                    </th>
                    <td>
                ...
                <tr>
                    <th scope="row">
                        <label for="address"><?php _e( 'Address', 'emon-toolkit' );?></label>
                    </th>
                    <td>
                ...
                <tr class="row<?php echo $this->has_error( 'phone' ) ? ' form-invalid' : ''; ?>">
                    <th scope="row">
                        <label for="phone"><?php _e( 'Phone', 'emon-toolkit' );?></label>
                    </th>
                    <td>
        ...
        <?php submit_button( __( 'Update Address', 'emon-toolkit' ), 'primary', 'submit_address' );?>
    </form>
</div>